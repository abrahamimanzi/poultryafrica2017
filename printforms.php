    ...
    if($participant_data->payment_state == "Confirmed" || $participant_data->payment_state == "Pending"){
        ...
        class PDF extends FPDF{
            ...
            function Header()
            {
                ...
                $this->Image(DN.'/img/logo.png',30,40,100);
                // Arial bold 15
                $this->SetFont('Arial','B',15);
                
                $this->SetFont('Arial','',10);
                // $this->Cell(0,15,EVENT,0,0,'R');
...
// Instanciation of inherited class
        ...
        $pdf->Cell(0,0,'To pay by bank transfer, kindly use the following details:',0,2,'C');
        ...
        $pdf->Cell(0,0,'',1,1,'L');
            ...
            $pdf->Ln(-25);
            $pdf->SetX(270);
            $pdf->Cell(90,25,'The events factory',0,1,'L');
            ...
            $pdf->Ln(-25);
            $pdf->SetX(270);
            $pdf->Cell(90,25,'00040-06945615-66',0,1,'L');
            ...
            $pdf->Ln(-25);
            $pdf->SetX(270);
            $pdf->Cell(90,25,'00040-06945614-65',0,1,'L');
            ...
            $pdf->Ln(-25);
            $pdf->SetX(270);
            $pdf->Cell(90,25,'Bank of Kigali, Head Quarters
KN 4 Ave, Kigali – Rwanda',0,1,'L');
        ...
        $pdf->SetY(565); 
        $pdf->SetFont('Arial','',10);
        $pdf->Cell(0,0,'regarding the payment, contact us on '.EMAIL1,0,2,'C');
        // $pdf->SetY(215); 
