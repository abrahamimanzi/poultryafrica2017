    ...
    if($participant_data->payment_state == "Confirmed"){
        ...
        class PDF extends FPDF{
            ...
            function Header()
            {
                ...
                $this->Image(DN.'/img/logo.png',30,40,80);
                // Arial bold 15
                ...
                // $this->Cell(0,65,'The events factory',0,0,'R');
                // $this->Cell(0,95,' theeventsfactory.biz',0,0,'R');
                // $this->Cell(0,125,'Tel: '.'+250 788 322 335',0,0,'R');
                // $this->Cell(0,150,'Email: '.'celestin.m@theeventsfactory.biz',0,0,'R');

                $this->Cell(0,65,EVENT,0,0,'R');
                $this->Cell(0,95,' poultryafrica2017.com',0,0,'R');
...
// Instanciation of inherited class
        ...
        $pdf->Cell(0,32,'Card number: '.$participant_item_data->card_number,0,0,'R');
        ...
        $pdf->Cell(0,0,'The events factory is collecting registration fee on behalf of poultry africa 2017',0,0,'C');

        $pdf->SetY(570); 
        $pdf->SetFont('Arial','',14);
        $pdf->Cell(0,0,'Any query please contact us on',0,0,'C');




                $pdf->SetY(590); 
                $pdf->Image(DN.'/img/tcl-logo.png',30,590,80);
                // $this->Image(DN.'/img/logo.png',30,40,80);
                // Arial bold 15
                $pdf->SetFont('Arial','B',15);
                
                $pdf->SetFont('Arial','',10);
                $pdf->Cell(0,30,'The events factory',0,0,'R');
                $pdf->Cell(0,55,' theeventsfactory.biz',0,0,'R');
                $pdf->Cell(0,80,'Tel: '.'+250 788 322 335',0,0,'R');
                $pdf->Cell(0,105,'Physical address: '.'KG 33 AV. NO 18, Kigali - Rwanda',0,0,'R');
                $pdf->Cell(0,130,'Email: '.'celestin.m@theeventsfactory.biz',0,0,'R');
