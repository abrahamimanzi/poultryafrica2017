...
<body class="home page page-id-2" style="overflow: hidden">
    ...
    <div class="sectiongrey">
        ...
        <section class="section-main " style="border-bottom: 0px solid #ddd; padding-bottom: 30px; background: rgba(180, 193, 224, 0);padding-top: 0px;color: aliceblue;"> 
        <?php
