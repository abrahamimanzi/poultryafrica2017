		...
		<div class="row">
			<div class="col-xs-12 col-sm-8">
				<h3 class="content-title">
					<i class="fa fa-user fa-lg pink-col"></i> User
					<small></small>
				</h3>
			</div>
        ...
        <nav class="navbar navbar-static-top navbar_content" role="navigation">
          ...
          <div class="navbar-branch-menu">
            <ul class="nav navbar-nav">
              ...
              <li class="">
                <a href="<?=DN?>/net"> <i class="fa fa-home"></i> Home </a>
              </li>
          ...
          <div class="col-sm-6">
              <form method="post">
                ...
                <div class="box box-info">
                    ...
                    <input type="hidden" name="request" value="subscriber-update">
                    <input type="hidden" name="id" value="<?php echo  $user_data->ID;?>">
                    <input type="hidden" name="token" value="true">
                    <input type="hidden" name="task" value="subscriber-update">
