            ...
            <div class="col-sm-8">
                    <div class="panel panel-reg" >
                        ...
                        <div class="reg-header" style="">
                                <h2 class="text-center reg-title" style="font-size: 18px; color: #cc0000;width: 100%;">Delegate Registration</h2>
                        ...
                        <?php if($form->ERRORS && (@$form->ERRORS_SCRIPT['email'][0] == 'NOTUNIQUE' || @$form->ERRORS_SCRIPT['document_number'][0] == 'NOTUNIQUE')){
                            ...
                            <div class="form-group">
                              <label class="control-label col-sm-3" for="company">Company
                                  <span  class="req">*</span> 
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-3" for="orgcategory">
                                    <!-- <span>Organization Category</span> -->
                                    <span>Which sector do you belong to?</span>
                                    <span  class="req">*</span> 
                                      ...
                                      <div class="row">
                                        <div class="col-sm-6">
                                            <select name="register-orgcategory" id="orgcategory" class="form-control bordered" onchange="Checkother1(this,'#orgcategory1');" required="required">
                                                ...
                                                <option value="Feedmill" <?php if($form->ERRORS && Input::get('register-orgcategory','post') == 'Feedmill'){ echo 'selected="selected"';}?>>Feedmill</option>
                                                
                                                <option value="Feed ingredients/additives manufacturer/distributor" <?php if($form->ERRORS && Input::get('register-orgcategory','post') == 'Feed ingredients/additives manufacturer/distributor'){ echo 'selected="selected"';}?>>Feed ingredients/additives manufacturer/distributor</option>
                                                
                                                <option value="Animal health manufacturer/distributor/services" <?php if($form->ERRORS && Input::get('register-orgcategory','post') == 'Animal health manufacturer/distributor/services'){ echo 'selected="selected"';}?>>Animal health manufacturer/distributor/services</option>
                                                
                                                <option value="Animal Industry equipment manufacturer/distributor" <?php if($form->ERRORS && Input::get('register-orgcategory','post') == 'Animal Industry equipment manufacturer/distributor'){ echo 'selected="selected"';}?>>Animal Industry equipment manufacturer/distributor</option>
                                                
                                                <option value="brioler farm" <?php if($form->ERRORS && Input::get('register-orgcategory','post') == 'brioler farm'){ echo 'selected="selected"';}?>>brioler farm</option>
                                                
                                                <option value="layer farm" <?php if($form->ERRORS && Input::get('register-orgcategory','post') == 'layer farm'){ echo 'selected="selected"';}?>>layer farm</option>
                                                
                                                <option value="hacthery farm" <?php if($form->ERRORS && Input::get('register-orgcategory','post') == 'hacthery farm'){ echo 'selected="selected"';}?>>hacthery farm</option>
                                                
                                                <option value="slaughtering" <?php if($form->ERRORS && Input::get('register-orgcategory','post') == 'slaughtering'){ echo 'selected="selected"';}?>>slaughtering</option>
                                                
                                                <option value="further processing" <?php if($form->ERRORS && Input::get('register-orgcategory','post') == 'further processing'){ echo 'selected="selected"';}?>>further processing</option>
                                                
                                                <option value="egg processing/handling" <?php if($form->ERRORS && Input::get('register-orgcategory','post') == 'egg processing/handling'){ echo 'selected="selected"';}?>>egg processing/handling</option>
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-3" for="industry">In which range of products are you interested in?
                                <span style="color: red; font-size: 12px; display: block"> <?php if($form->ERRORS){ echo @$form->ERRORS_SCRIPT['industry'][0];}?> </span>
                                </label>
                              <div class="col-sm-9" style="text-align: -webkit-auto;">
                                  <div class="row">
                                      <div class="col-sm-12">
                                          <?php /* ?><select name="register-industry[]" multiple size="4"  id="industry" class="form-control bordered">
                                          <?php
                                          ...
                                          <?php 
                                            for($i=0;$i<count($array);$i++){?>
                                                <option value="<?=$array[$i];?>" 
                                                        <?php if($form->ERRORS && @in_array($array[$i],Input::get('register-industry','post'))){ echo 'selected="selected"'; }?>><?=$array[$i];?> </option>
                                            <?php
                                            } 
                                          ?>
                                        </select><?php */ ?>
                                        <?php
                                          // $array = array("Up to date financial information","A working financial model","Up to date investor presentation","A detailed business plan")
                                          $array = array("Animal health","Feed/ ingredients and Addivites","Feed/ Industrial Compound Feed Processing","Animal breeding and hatching equiment","Farm equipment & Housing equipment","Slaughtering, Handling,Processing equipment")
                                          ?>  
                                          <?php 
                                            for($i=0;$i<count($array);$i++){?>
                                            <input type="checkbox" name="industry[]" id="industry" value="<?=$array[$i];?>" <?php if($form->ERRORS && @in_array($array[$i],Input::get('industry','post'))){ echo 'checked'; }?>>&nbsp;<?=$array[$i];?><br>
                                            <?php
                                            } 
                                          ?>
                                      </div>
                            ...
                            <div class="form-group">
                              <label class="control-label col-sm-3" for="referenceby">How did you hear about us?
                                <span  class="req">*</span> 
                                  <span style="color: red; font-size: 12px; display: block"> <?php if($form->ERRORS){ echo @$form->ERRORS_SCRIPT['referenceby'][0];}?> </span>
                              </label>
                              <div class="col-sm-9">
                                  <div class="row">
                                      <div class="col-sm-6">
                                        ...
                                        <select name="register-referenceby" id="referenceby" class="form-control bordered" onchange="Checkother1(this,'#referenceby1');" required="required">
                                           
                                            <option value="" <?php if($form->ERRORS && Input::get('register-referenceby','post') == ''){ echo 'selected="selected"';}?>> [--Select--] </option>
                                            
                                            <option value="Netherlands-Africa Business Council (NABC)" <?php if($form->ERRORS && Input::get('register-referenceby','post') == 'Netherlands-Africa Business Council (NABC)'){ echo 'selected="selected"';}?>>Netherlands-Africa Business Council (NABC)</option>
                                            
                                            <option value="Direct mail from organizers" <?php if($form->ERRORS && Input::get('register-referenceby','post') == 'Direct mail from organizers'){ echo 'selected="selected"';}?>>Direct mail from organizers</option>
                                            
                                            <option value="Advertisement in magazine. Please specify in which magazine:" <?php if($form->ERRORS && Input::get('register-referenceby','post') == 'Advertisement in magazine. Please specify in which magazine:'){ echo 'selected="selected"';}?>>Advertisement in magazine. Please specify in which magazine:</option>

                                            <option value="Other" <?php if($form->ERRORS && Input::get('register-referenceby','post') == 'Other'){ echo 'selected="selected"';}?>>Other </option>
                                        </select>
                                      </div>
                                      <div class="col-sm-6">
                                           <input type="text" class="form-control" name="register-referenceby1" id="referenceby1" placeholder="Please specify"
                                                  <?php if($form->ERRORS && Input::get('register-referenceby','post') == 'Other'){?> 
                                                  value="<?php echo Input::get('register-referenceby1','post');?>" 
                                                  <?php }?>
                                                  <?php if($form->ERRORS && Input::get('register-referenceby','post') != 'Other'){?> disabled="disabled" <?php }?> 
                                                  <?php if(!$form->ERRORS){?> disabled="disabled" <?php }?>  maxlength="100" required="required">
                                      </div>
                                  </div>
                              </div>
                            </div>
...
-->
                                    By clicking submit, you hereby confirm that you agree to our Terms and Conditions and Privacy Policy
                                </label>
