            ...
            <div class="col-sm-8">
                    <div class="panel panel-reg" >
                        ...
                        <div class="reg-header" style="">
                            <h2 class="text-center reg-title" style="font-size: 20px; color: #fff">Media Pass Registration</h2>
                        </div>
...
-->
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-3" for="special_request">Special Request <small>(Up to 500 characters)</small> 
                                  <span style="color: red; font-size: 12px; display: block"> <?php if($form->ERRORS){ echo @$form->ERRORS_SCRIPT['special_request'][0];}?> </span>
                                </label>
                              <div class="col-sm-9">
                                  <div class="row">
                                      <div class="col-sm-12">
                                          <textarea name="register-special_request" type="text" rows="3" cols="10" class="form-control" id="special_request" maxlength="500" placeholder="<?php if($categ == "Media"){ echo 'eg. Mayors Interviews, sessions cover,...';}?> <?php if($categ == "Speaker"){ echo 'Proposal Summary';}?>"><?php if($form->ERRORS && Input::get('register-special_request','post')){ echo Input::get('register-special_request','post'); }?></textarea>
                                      </div>
                                  </div>
                              </div>
                            </div>
