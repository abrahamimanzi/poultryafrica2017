            ...
            <div class="col-sm-8">
                    <div class="panel panel-reg" >
                        ...
                        <div class="reg-header" style="">
                                <h2 class="text-center reg-title" style="font-size: 20px; color: #fff">Missing property Registration</h2>
                        </div>
                        ...
                        <?php if($form->ERRORS && (@$form->ERRORS_SCRIPT['email'][0] == 'NOTUNIQUE' || @$form->ERRORS_SCRIPT['document_number'][0] == 'NOTUNIQUE')){
                            ...
                            <div class="form-group">
                              <label class="control-label col-sm-3" for="action">Lost or Get
                                <span  class="req">*</span> 
                                </label>
                              <div class="col-sm-9">
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-12" for="info">Describe about missing property? <br><small>(Up to 200 words)</small>
                                <span  class="req">*</span>
